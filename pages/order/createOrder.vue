<template>
	<view>
		...
		<view class="goods-section">
			...
			<!-- 商品列表 -->
			<view class="g-item">
				<image :src="this.goodsList.pic"></image>
				<view class="right">
					<text class="title clamp">{{this.goodsList.name}}</text>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{this.goodsList.promotionPrice}}</text>
			</view>
			<view class="yt-list-cell b-b">
...
<script>
	export default {
		...
		methods: {
			...
			submit(){
				uni.redirectTo({
					url: '/pages/money/pay?id='+this.goodsList.id
				})
			},
			stopPrevent(){}
		}
